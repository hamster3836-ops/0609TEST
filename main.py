...
# 4. 데이터: 기분별 메뉴, 레시피, 칼로리, 맞춤 운동
menu_data = {
    "🔥 스트레스 팍! (매운맛)": [
        {"name": "매운 쭈꾸미 볶음", "calories": "약 350 kcal", "exercise": "스트레스 날리는 허공 펀치 30회 & 가벼운 제자리 뛰기 3분", "recipe": "1. 쭈꾸미를 밀가루로 문질러 씻습니다.\n2. 고추장, 고춧가루, 간장, 다진마늘, 매실액으로 양념장을 만듭니다.\n3. 파와 양파를 기름에 볶다가 쭈꾸미와 양념장을 넣고 센 불에 빠르게 볶아냅니다.\n4. 콩나물을 곁들이면 더욱 맛있습니다."},
        {"name": "국물 닭발", "calories": "약 400 kcal", "exercise": "매운맛 달래주는 시원한 폼롤러 전신 마사지 10분", "recipe": "1. 닭발을 끓는 물에 한번 데쳐 잡내를 제거합니다.\n2. 고추장, 고춧가루, 청양고추, 간장, 올리고당을 섞어 매운 양념을 만듭니다.\n3. 냄비에 닭발과 양념, 물을 자작하게 붓고 푹 끓여줍니다.\n4. 주먹밥과 계란찜을 꼭 곁들여 드세요."}
    ],
    "🛌 너무 피곤해 (든든한 국물)": [
        {"name": "차돌박이 된장찌개", "calories": "약 450 kcal (밥 포함 750 kcal)", "exercise": "따뜻한 물로 샤워 후, 침대 위에서 L자 다리 휴식 10분", "recipe": "1. 뚝배기에 차돌박이를 먼저 볶아 기름을 냅니다.\n2. 쌀뜨물을 붓고 된장과 고추장을 3:1 비율로 풉니다.\n3. 애호박, 양파, 두부, 버섯을 썰어 넣고 끓입니다.\n4. 마지막에 청양고추와 파를 썰어 넣어 칼칼함을 더합니다."},
        {"name": "뜨끈한 스지 어묵탕", "calories": "약 300 kcal", "exercise": "뭉친 어깨와 목을 부드럽게 풀어주는 앉아서 하는 요가 5분", "recipe": "1. 스지(소 힘줄)를 핏물을 빼고 푹 삶아 부드럽게 만듭니다.\n2. 무와 대파, 다시마로 맑은 육수를 냅니다.\n3. 꼬치 어묵과 삶은 스지를 육수에 넣고 국간장으로 간을 맞춥니다.\n4. 쑥갓을 올려 향긋하게 마무리합니다."}
    ],
    "✨ 기분 전환이 필요해 (특별한 요리)": [
        {"name": "트러플 크림 파스타", "calories": "약 600 kcal", "exercise": "좋아하는 신나는 음악 틀어놓고 리듬 타며 방 청소하기 15분", "recipe": "1. 파스타 면을 알단테로 삶아 건져냅니다.\n2. 팬에 버터를 두르고 다진 양파와 버섯을 볶습니다.\n3. 생크림과 우유를 붓고 끓이다가 면을 넣고 졸입니다.\n4. 소금, 후추로 간을 하고 마지막에 트러플 오일을 몇 방울 뿌려 풍미를 더합니다."},
        {"name": "비프 스테이크", "calories": "약 700 kcal", "exercise": "소화 촉진을 위한 선선한 밤공기 마시며 동네 산책 20분", "recipe": "1. 소고기를 상온에 꺼내두고 소금, 후추, 올리브오일로 마리네이드합니다.\n2. 팬을 아주 뜨겁게 달군 후 고기를 올려 겉면을 튀기듯 굽습니다.\n3. 버터와 마늘, 타임(허브)을 넣고 고기에 끼얹으며 굽습니다.\n4. 고기를 꺼내 5분간 레스팅 한 후 썰어 먹습니다."}
    ],
    "🥗 가볍고 속 편하게 (건강식)": [
        {"name": "연어 아보카도 포케", "calories": "약 400 kcal", "exercise": "건강한 몸을 위한 코어 강화 플랭크 1분 x 3세트", "recipe": "1. 생연어를 깍둑썰기하여 간장, 참기름, 스리라차 소스에 살짝 버무립니다.\n2. 현미밥을 그릇에 담고 위에 연어, 슬라이스한 아보카도, 오이, 양파를 올립니다.\n3. 김가루와 날치알, 깨를 뿌려줍니다.\n4. 취향에 따라 스리라차 마요 소스를 곁들여 비벼 먹습니다."},
        {"name": "닭가슴살 샐러드 랩", "calories": "약 350 kcal", "exercise": "가벼워진 몸으로 전신 스쿼트 15회 x 3세트", "recipe": "1. 통밀 또띠아를 마른 팬에 살짝 굽습니다.\n2. 닭가슴살을 찢어 머스타드나 그릭 요거트에 버무립니다.\n3. 또띠아 위에 로메인(상추), 토마토, 닭가슴살을 올립니다.\n4. 단단하게 말아 반으로 썰어 먹습니다."}
    ],
    "☔ 비가 주룩주룩 (기름진 전과 면)": [
        {"name": "바삭한 해물파전", "calories": "약 550 kcal", "exercise": "창밖 빗소리 들으며 실내 자전거 타기 15분 (없다면 제자리 걷기)", "recipe": "1. 쪽파를 썰고 오징어, 새우 등 해물을 준비합니다.\n2. 부침가루와 튀김가루를 섞어 반죽을 묽게 만듭니다.\n3. 기름을 넉넉히 두른 팬에 파를 올리고 해물과 반죽을 부어 바삭하게 굽습니다.\n4. 초간장을 곁들여 막걸리와 함께 즐깁니다."},
        {"name": "시원한 바지락 칼국수", "calories": "약 500 kcal", "exercise": "누워서 하는 가벼운 자전거 타기(하늘 자전거) 동작 5분", "recipe": "1. 바지락은 굵은소금을 푼 물에 해감해 둡니다.\n2. 멸치와 다시마로 진한 육수를 냅니다.\n3. 육수가 끓으면 칼국수 면과 애호박, 당근, 바지락을 넣고 끓입니다.\n4. 국간장과 소금으로 간을 하고 청양고추를 송송 썰어 넣습니다."}
    ],
    "💸 월급날! 나를 위한 플렉스 (고급 요리)": [
        {"name": "버터갈릭 랍스터 구이", "calories": "약 450 kcal", "exercise": "기분 좋게 팔 벌려 뛰기(PT 체조) 20회", "recipe": "1. 랍스터를 깨끗이 씻어 반으로 가릅니다.\n2. 녹인 버터에 다진 마늘, 파슬리, 꿀을 섞어 소스를 만듭니다.\n3. 랍스터 살 위에 소스를 듬뿍 바르고 모짜렐라 치즈를 올립니다.\n4. 180도 오븐이나 에어프라이어에서 15분간 노릇하게 굽습니다."},
        {"name": "양갈비 스테이크", "calories": "약 650 kcal", "exercise": "기지개 시원하게 켜고, 폼롤러로 등 근육 풀어주기 10분", "recipe": "1. 양갈비 핏물을 닦고 올리브유, 소금, 후추, 로즈마리로 밑간을 합니다.\n2. 뜨겁게 달군 팬에 양갈비를 올리고 앞뒤로 겉면을 바싹 굽습니다.\n3. 불을 줄이고 속까지 원하는 굽기로 익힌 후 레스팅합니다.\n4. 민트 젤리나 쯔란을 곁들여 먹습니다."}
    ],
    "🛋️ 다 귀찮아.. (초간단 레시피)": [
        {"name": "버터 간장계란밥", "calories": "약 480 kcal", "exercise": "오늘은 무리하지 마세요! 숨쉬기 운동 및 꿀잠 자기 😴", "recipe": "1. 따뜻한 밥 한 공기를 준비합니다.\n2. 계란 프라이를 반숙으로 부칩니다.\n3. 밥 위에 버터 한 조각과 계란 프라이를 올립니다.\n4. 간장 1스푼과 참기름을 두르고 쓱쓱 비벼 먹습니다. 김자반을 추가하면 완벽합니다."},
        {"name": "스팸 참치마요 덮밥", "calories": "약 650 kcal", "exercise": "방 안에서 물 한잔 마시며 3분만 가볍게 서성거리기", "recipe": "1. 스팸을 깍둑썰기하여 바싹 굽고, 참치는 기름을 꽉 짭니다.\n2. 그릇에 밥을 담고 스팸과 참치를 올립니다.\n3. 마요네즈를 지그재그로 뿌리고 김가루를 얹습니다.\n4. 볶은 양파나 스크램블 에그를 더하면 더욱 든든합니다."}
    ],
    "🍷 혼술 한잔 하고 싶은 밤 (안주거리)": [
        {"name": "감바스 알 아히요", "calories": "약 550 kcal", "exercise": "알코올 분해를 돕는 따뜻한 물 한잔과 목 스트레칭 3분", "recipe": "1. 팬에 올리브오일을 넉넉히 붓고 편마늘과 페페론치노를 넣어 약불에서 향을 냅니다.\n2. 마늘이 노릇해지면 손질한 새우를 넣고 소금, 후추로 간을 합니다.\n3. 새우가 익으면 방울토마토와 파슬리를 넣고 가볍게 섞어줍니다.\n4. 바게트 빵을 곁들여 오일에 찍어 먹습니다."},
        {"name": "삼겹살 숙주볶음", "calories": "약 600 kcal", "exercise": "벽 짚고 서서 종아리 늘려주는 스트레칭 5분", "recipe": "1. 대패 삼겹살이나 얇은 돼지고기를 팬에 굽습니다.\n2. 고기가 반쯤 익으면 굴소스, 간장, 설탕, 다진마늘을 넣고 볶습니다.\n3. 고기가 다 익으면 씻어둔 숙주를 듬뿍 넣고 센 불에서 빠르게 1분만 볶아냅니다.\n4. 아삭한 식감이 살아있을 때 불을 끄고 통깨를 뿌립니다."}
    ]
}
...
if st.button("✨ 오늘의 저녁 메뉴 추천받기", use_container_width=True):
    ...
    # 칼로리 및 운동 추천 박스 (Streamlit Info 박스 활용)
